//! Trend Following Long — run on March 7-14, 2025.

use crate::backtest::BacktestEngine;
use nexus_strategy::TrendFollowingStrategy;
...
fn main() {
    ...
    println!("Trend Following Long — March 7-14, 2025");
    println!("Data dir: {:?}\n", data_dir);
    ...
    let result = BacktestEngine::new()
        ...
        .run(|| TrendFollowingStrategy::new(20, 50, 14, 2.0, 1.0))
